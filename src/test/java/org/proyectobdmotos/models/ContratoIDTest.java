...
public class ContratoIDTest extends TestCase {
    ...
    public void testEqualsDebeRetornarTrueCuandoEsMismaReferencia() {
        ContratoID contratoId = new ContratoID(LocalDate.of(2026, 4, 20), "M-101");
    ...
    public void testEqualsDebeCompararSoloCamposDeLlavePrimaria() {
        ContratoID contratoIdA = new ContratoID(LocalDate.of(2026, 4, 20), "M-101");
        ContratoID contratoIdB = new ContratoID(LocalDate.of(2026, 4, 20), "M-101");
    ...
    public void testEqualsDebeSerNullSafeParaCamposDelId() {
        ...
        ContratoID contratoIdConMatriculaDistinta = new ContratoID(null, "M-202");

        assertTrue(contratoIdConNulosA.equals(contratoIdConNulosB));
        assertFalse(contratoIdConNulosA.equals(contratoIdConMatriculaDistinta));
    }
